...
// struct PlzjLxeAudioWav {
//   uint32_t len;
//   unsigned char data[len];
// } __packed;


struct PlzjLxeAudioWavZlib {
  uint32_t chunks_cnt;
...
#define PLZJ_AUDIO_WAV_ZLIB_MAX_CHUNK_SIZE 125000


struct PlzjLxeAudioMP3 {
