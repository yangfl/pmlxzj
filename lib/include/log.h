...
__attr_access((__read_only__, 2)) __attr_access((__read_only__, 4))
/**
...
__nonnull((3)) __attr_access((__read_only__, 1))
...
__THROW __attribute_noinline__ __attr_access((__write_only__, 1, 2))
int sc_save_backtrace (void **frames, int size, int skip);
__nonnull((1, 3)) __attr_access((__read_only__, 1, 2))
int sc_print_backtrace_f (
  void *const *frames, int size, sc_print_fn_t printer, void *data);
__THROW __nonnull() __attr_access((__read_only__, 1, 2))
...
__THROW __nonnull()
int sc_register_strerror (unsigned int domain, sc_strerror_fn_t strfn);

__THROW __attribute_noinline__ __attr_access_none(3)
int sc_set_err (unsigned long domain, int code, const char *fn);
__THROW __attribute_noinline__ __attr_access_none(1)
int sc_set_errno (const char *fn);
__nonnull((1))
