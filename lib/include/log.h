...
DLL_PUBLIC __nonnull((2)) __attr_access((__read_only__, 2))
...
DLL_PUBLIC __attr_access((__read_only__, 2)) __attr_access((__read_only__, 4))
/**
...
DLL_PUBLIC __nonnull((3)) __attr_access((__read_only__, 1))
...
DLL_PUBLIC __nonnull() __attr_access((__read_only__, 1))
...
DLL_PUBLIC __THROW __attribute_noinline__ __attr_access((__write_only__, 1, 2))
int sc_save_backtrace (void **frames, int size, int skip);
DLL_PUBLIC __nonnull((1, 3)) __attr_access((__read_only__, 1, 2))
int sc_print_backtrace_f (
  void *const *frames, int size, sc_print_fn_t printer, void *data,
  const char *indent);
DLL_PUBLIC __THROW __nonnull((1, 3)) __attr_access((__read_only__, 1, 2))
...
DLL_PUBLIC __nonnull((1, 2)) __attr_access((__read_only__, 1))
...
DLL_PUBLIC __THROW __attribute_noinline__ __attr_access_none(3)
int sc_set_err (
  unsigned long domain, int code, const char *fn, const char *what);
DLL_PUBLIC __THROW __attribute_noinline__ __attr_access_none(3)
__attr_format((printf, 4, 5))
int sc_set_err_printf (
  unsigned long domain, int code, const char *fn, const char *format, ...);
DLL_PUBLIC __THROW __attribute_noinline__ __attr_access_none(1)
int sc_set_errno (const char *fn, const char *what);
DLL_PUBLIC __nonnull((1)) __attr_access((__read_only__, 3))
__attr_access((__read_only__, 4))
int sc_print_err_f (
  sc_print_fn_t printer, void *data, const char *indent, const char *bt_indent);
DLL_PUBLIC __THROW __nonnull((1)) __attr_access((__read_only__, 2))
__attr_access((__read_only__, 3))
