...
int sc_print_backtrace_f (
  ...
  const char *indent);
PLZJ_API __THROW __nonnull((1, 3)) __attr_access((__read_only__, 1, 2))
...
PLZJ_API __THROW __attribute_noinline__ __nonnull((1))
...
PLZJ_API __THROW __attribute_noinline__ __attr_access((__read_only__, 3))
__attr_access((__read_only__, 4)) __attr_format((printf, 4, 5))
int sc_set_err_fmt (
