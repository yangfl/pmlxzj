...
* x264: `ffmpeg [-i audio.wav] -i video.apng -r 30 -c:v libx264 -pix_fmt yuv444p10le -tune stillimage -rreset veryslow video.mp4`
...
请将上面 ffmpeg 的 `-r` 选项替换为程序提示的值（或其因数），否则可能产生顿挫感。
